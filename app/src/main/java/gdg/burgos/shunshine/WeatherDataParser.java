...
public class WeatherDataParser {
    ...
    public static void main(String[] args) {
        ...
        try {
            getMaxTemperatureForDay(WEATHER_DATA_MTV_JUN_4, 2);
    ...
    public static double getMaxTemperatureForDay(String weatherJsonStr, int dayIndex) throws JSONException {
        ...
        JSONObject j = new JSONObject(weatherJsonStr);
        JSONArray array = j.getJSONArray("list");
        JSONObject day = array.getJSONObject(dayIndex);
        JSONObject day2 = day.getJSONObject("temp");
        return day2.getDouble("max");
