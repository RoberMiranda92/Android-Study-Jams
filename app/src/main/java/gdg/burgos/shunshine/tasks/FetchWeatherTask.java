    ...
    protected String[] doInBackground(String... params) {
        ...
        try {
            ...
            Uri buildUri = Uri.parse(FORECAST_BASE_URL).buildUpon()
                    ...
                    .appendQueryParameter(FORMAT_PARAM, FORMAT_DATA)
                    .appendQueryParameter(UNITS_PARAM, UNITS_DATA)
                    .appendQueryParameter(DAYS_PARAM, DAYS_DATA)
                    .appendQueryParameter(API_PARAM, API_DATA)
                    .build();
            ...
            return getWeatherDataFromJson(forecastJsonStr, Integer.valueOf(DAYS_DATA));
